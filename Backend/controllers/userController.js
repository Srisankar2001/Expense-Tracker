...
const  addFriend = async(req,res) => {
    ...
    try{
        ...
        return res.status(200).json({success:false, message: "Friend added successfully"})
    }catch(error){
...
const  removeFriend = async(req,res) => {
    ...
    try{
        ...
        return res.status(200).json({success:false, message: "Friend removed successfully"})
    }catch(error){
        return res.status(500).json({success:false, message: "Internal Server Error"})
    }
}
